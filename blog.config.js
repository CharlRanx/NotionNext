...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'be61e79e1ffb43c9a65a8fd2b2161566',
  ...
  AUTHOR: 'charlranx', // 作者
  BIO: 'Don Not Panic⚠️', // 作者简介
  LINK: 'www.charlranx.top', // 网站地址
  KEYWORDS: 'CharlRanx Blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'ranxcharl@gmail.com', // 邮箱
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'CharlRanx BLOG', // 站点标题 ，被notion中的页面标题覆盖
